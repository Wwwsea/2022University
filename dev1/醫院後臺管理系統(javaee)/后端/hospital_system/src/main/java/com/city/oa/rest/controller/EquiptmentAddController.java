 ...
 * 接收藥物的JSON数据。
 */
@WebServlet("/api/client/add.do")
public class EquiptmentAddController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//REST发送JSON给前端
			result.setStatus("Y");
			result.setMessage("增加設備成功⎛⎝≥⏝⏝≤⎛⎝");
			
		}
		catch(Exception e) {
			result.setStatus("N");
			result.setMessage("增加設備失败 XoX....,失败 XoX....原因:"+e.getLocalizedMessage());
		}
		//将Result对象转换为JSON
